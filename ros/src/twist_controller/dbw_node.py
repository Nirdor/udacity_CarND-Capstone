...
class DBWNode(object):
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if not None in [self.velocity, self.twist, self.dbw]:
                throttle, brake, steering = self.controller.control(self.dbw, self.velocity, self.twist.linear.x, self.twist.angular.z)
    ...
    def current_velocity_cb(self, current_velocity):
        self.velocity = current_velocity.twist.linear.x
